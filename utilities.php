...
function showConfirm(msg, frm) {
   var win = document.getElementById("alert");
   // msg = msg.replace(/(\n)+/g, "<br>");
   msg += "<p/><div class='pure-g'>" +
     "<input type='button' class='submitbutton pure-button' value='Confirm' onclick=\"confirmYes('"
      + frm + "');\">";
   msg += // "<div class='pure-u-1-2'>" + 
// &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     "<input type='button' class='submitbutton pure-button' value='Cancel' onclick='closeAlert();'></div>";
